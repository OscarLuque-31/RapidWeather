    ...
    return FutureBuilder<WeatherResponse>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (weatherResponse.forecast!.forecastday.length == 1) {
            var weatherToday = weatherResponse.forecast!.forecastday.first;
              ...
              child: Column(
                ...
                children: [
                  ...
                  WeatherForHoursAndDays(
                      forecastDay: weatherToday, especificaciones: true),
            ...
            return const Center(
                child: Text('No hay suficientes datos de pronóstico.'));
          }
        }
      },
    );
